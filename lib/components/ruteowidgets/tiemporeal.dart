                    ...
                    children: [
                      Container(
                        ...
                        decoration: BoxDecoration(
                            ...
                            border: Border.all(
                                width: 3,
                                color: Color.fromARGB(255, 16, 133, 21))),
                        child: Center(
                            child: Text(
                          "${count}",
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                            ...
                            image: DecorationImage(
                                image:
                                    AssetImage('lib/imagenes/pin_verde.png'))),
                      ...
                      children: [
                        Container(
                          ...
                          decoration: BoxDecoration(
                              ...
                              border: Border.all(
                                  width: 3,
                                  color: Color.fromARGB(255, 165, 180, 32))),
                          child: Center(
                              child: Text(
                            "${count}",
                            style: const TextStyle(
                    ...
                    return Row(
                      children: [
                        Container(
                          ...
                          decoration: BoxDecoration(
                              color: Color.fromARGB(255, 57, 175, 42),
                              borderRadius: BorderRadius.circular(20)),
                        ...
                        Container(
                          ...
                          height: 40,
                          decoration: BoxDecoration(
                              color: const Color.fromARGB(255, 57, 175, 42),
                              borderRadius: BorderRadius.circular(50)),
                          child: IconButton(
                              onPressed: () {
                                showDialog(
                    ...
                    return Row(
                      children: [
                        Container(
                          ...
                          padding: const EdgeInsets.all(10),
                          decoration: BoxDecoration(
                              color: Color.fromARGB(255, 185, 218, 40),
                              //.withOpacity(0.5),
                              borderRadius: BorderRadius.circular(20)),
                          margin: const EdgeInsets.all(10),
                          child: Column(
                        ...
                        Container(
                          ...
                          height: 40,
                          decoration: BoxDecoration(
                              color: const Color.fromARGB(255, 185, 218, 40),
                              borderRadius: BorderRadius.circular(50)),
                          child: IconButton(
                              onPressed: () {
                                showDialog(
