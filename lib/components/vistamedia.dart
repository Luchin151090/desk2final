...
Future<void> createPdf() async {
  ...
  final html.AnchorElement anchor = html.AnchorElement(href: url)
    ..setAttribute('download', 'informe_${now.day}-${now.month}-${now.year}.pdf')
    ..click();
              ...
              Padding(
                ...
                child: Container(
                  ...
                  child: ElevatedButton(onPressed: (){
                    Navigator.push(context,MaterialPageRoute(builder: (BuildContext context)=>Tienda()));
                  },
                  style: ButtonStyle(
                    backgroundColor: WidgetStateProperty.all(Colors.white)
                  ),
                   child: Text("Crear pedido",style: TextStyle(color:Colors.black,fontWeight: FontWeight.bold),)),
                ),
              ),
               ...
               Padding(
                ...
                child: Container(
                  width: MediaQuery.of(context).size.width/2.5,
                  child: ElevatedButton(onPressed: (){
                     Navigator.push(context,MaterialPageRoute(builder: (BuildContext context)=>Vista0()));
                  },
                  style: ButtonStyle(
                    backgroundColor: WidgetStateProperty.all(Colors.white)
                  ),
                   child: Text("Crear ruta manual",style: TextStyle(color:Colors.black,fontWeight: FontWeight.bold),)),
                ),
              ),
               Padding(
                padding: const EdgeInsets.only(left: 100,bottom: 50),
                child: Container(
                  ...
                  child: ElevatedButton(onPressed: (){},
                  style: ButtonStyle(
                    backgroundColor: WidgetStateProperty.all(Color.fromARGB(255, 109, 109, 109))
                  ),
                   child: Text("Crear ruta automática",style: TextStyle(color:const Color.fromARGB(255, 76, 76, 76),fontWeight: FontWeight.bold),)),
                ),
              ),
               Padding(
                padding: const EdgeInsets.only(left: 100,bottom: 50),
                child: Container(
                  width: MediaQuery.of(context).size.width/2.5,
                  child: ElevatedButton(onPressed: (){
                     Navigator.push(context,MaterialPageRoute(builder: (BuildContext context)=>DataTableExample()));
                  },
                  style: ButtonStyle(
                    backgroundColor: WidgetStateProperty.all(Colors.white)
                  ),
                   child: Text("Gestionar pedidos",style: TextStyle(color:Colors.black,fontWeight: FontWeight.bold),)),
                ),
              ),
               Padding(
                padding: const EdgeInsets.only(left: 100,bottom: 50),
                child: Container(
                  ...
                  style: ButtonStyle(
                   ...
                   child: Text("Descargar informe",style: TextStyle(color:Colors.black,fontWeight: FontWeight.bold),)),
                ),
              ),
