...
class _DataTableExampleState extends State<DataTableExample> {
  ...
  Future<void> fetchPedidos() async {
    ...
    final response = await http.get(Uri.parse(
        'http://147.182.251.164/api/pedidosDesktop')); //+empleadosID.toString()));
  ...
  void _showEditDialog(BuildContext context, Map<String, dynamic> pedido) {
    ...
    TextEditingController observacionController =
        TextEditingController(text: pedido['observacion'] ?? 'NA');
              ...
              child: SingleChildScrollView(
                ...
                child: DataTable(
                  ...
                  columns: <DataColumn>[
                    DataColumn(
                      label: const Text('ID'),
                      onSort: (int columnIndex, bool ascending) => _sort<int>(
                          (item) => item['id'], columnIndex, ascending),
                    ),
                    DataColumn(
                    ...
                    DataColumn(
                      label: const Text('Apellidos',
                          style: TextStyle(fontStyle: FontStyle.italic)),
                      onSort: (int columnIndex, bool ascending) =>
                          _sort<String>((item) => item['apellidos'],
                    ...
                    DataColumn(
                      label: const Text('Distrito',
                          style: TextStyle(fontStyle: FontStyle.italic)),
                      onSort: (int columnIndex, bool ascending) =>
                          _sort<String>((item) => item['distrito'], columnIndex,
                              ascending),
                    ),
                    DataColumn(
                    ...
                    DataColumn(
                      ...
                      onSort: (int columnIndex, bool ascending) =>
                          _sort<String>(
                              (item) => item['ruta_id'] != null
                                  ? item['ruta_id'].toString()
                                  : '',
                              columnIndex,
                              ascending),
                    ),
                  ...
                  rows: List<DataRow>.generate(
                    ...
                    (index) => DataRow(
                      cells: <DataCell>[
                        ...
                        DataCell(
                            Text(filteredItems[index]['total'].toString())),
                        DataCell(Text(filteredItems[index]['distrito'])),
                        DataCell(
                          Text(
                              filteredItems[index]['observacion']?.toString() ??
                                  'NA'),
                        ),
                        DataCell(Text(
                          ...
                          style: TextStyle(
                              ...
                              fontSize: 9 + 2,
                              color: filteredItems[index]['tipo'].toString() ==
                                      'normal'
                                  ? const Color.fromARGB(255, 33, 40, 243)
                                  : Color.fromARGB(255, 23, 109, 26)),
                        )),
                        DataCell(Text(
                        ...
                        DataCell(Text(
                          filteredItems[index]['ruta_id']?.toString() ?? 'N/A',
                        )),
                        DataCell(
                          Row(
                            children: [
